...
class CreditCardsContainer extends React.Component {
    ...
    nextThree = () => {
        ...
        this.setState({ startIndex: newIndex >= this.state.cards.length ? 0 : newIndex })
    }
    ...
    render(){
        ...
        return(
            <React.Fragment>
                ...
                <h1 onClick={this.prevThree}>Prev</h1>
                {threeCards.map(card => {
                    return (
                        <div className="cc-card">
                            ...
                            <a href={card.application_url} target="_blank"><button className="btn btn-success">
                            Apply Now 
                ...
                <h1 onClick={this.nextThree}>more</h1>
                </div>
            </React.Fragment>
        )
    }
